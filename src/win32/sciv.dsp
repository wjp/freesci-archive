...
# ADD CPP /nologo /W3 /GX /Zi /O1 /Ob2 /I "..\..\..\SDL-1.2.2\include" /I "..\include" /I "..\include\win32" /D "HAVE_SDL" /D "NDEBUG" /D PACKAGE=\"FreeSCI\" /D VERSION=\"pre-0.3.3\" /D "HAVE_GETOPT_H" /D "HAVE_USLEEP" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "HAVE_STRING_H" /D "HAVE_DDRAW" /FD /c
# SUBTRACT CPP /Fr
...
# ADD LINK32 Release\fsci.lib ..\..\..\SDL-1.2.2\lib\SDL.lib winmm.lib kernel32.lib user32.lib gdi32.lib advapi32.lib uuid.lib ddraw.lib /nologo /subsystem:console /map:"..\..\bin\freesci.map" /debug /machine:I386 /out:"..\..\bin\freesci.exe" /FIXED:NO
...
# ADD CPP /nologo /W3 /Gm /Gi /GR /GX /ZI /Od /I "..\..\..\SDL-1.2.2\include" /I "..\include" /I "..\include\win32" /D "_DEBUG" /D PACKAGE=\"freesci\" /D VERSION=__TIMESTAMP__ /D "HAVE_DDRAW" /D "HAVE_GETOPT_H" /D "HAVE_LIBPNG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "HAVE_STRING_H" /FR /YX /FD /GZ /c
