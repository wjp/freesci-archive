...
sci_game_t sci_games[] = {
	...
	{ 0x13DD3CD2, SCI_VERSION_AUTODETECT, SCI_VERSION(0,000,343), "LSL2" },
	{ 0x0C848403, SCI_VERSION_AUTODETECT, SCI_VERSION(0,000,409), "LSL2" },
	{ 0xC48FE83A, SCI_VERSION_AUTODETECT, SCI_VERSION(0,000,572), "LSL3" },
	...
	{ 0xFEAB629D, SCI_VERSION_AUTODETECT, SCI_VERSION(0,000,343), "LSL2 v1.000.011-3.5"},
	{ 0x40BEC726, SCI_VERSION_AUTODETECT, SCI_VERSION(0,000,409), "LSL2 v1.002.000-3.5"},
	{ 0x06D737B5, SCI_VERSION_AUTODETECT, SCI_VERSION(0,000,572), "LSL3 v1.003-3.5"},
	{ 0x484587DD, SCI_VERSION_AUTODETECT, SCI_VERSION(0,000,572), "LSL3 v1.021-5.25"},
	...
	{ 0xCF116CDF, SCI_VERSION_AUTODETECT, SCI_VERSION(1,000,577), "LSL1 v2.1"},
	...
	/* Amiga ports. Interpreter versions are merely tentative */
	...
	{ 0x7E9CF339, SCI_VERSION_AUTODETECT, SCI_VERSION(0,000,572), "LSL2 v1.003-ami"}, /* x.yyy.zzz */
	{ 0x6348030A, SCI_VERSION_AUTODETECT, SCI_VERSION(0,000,572), "LSL3 v1.039-ami"}, /* 1.002.032 */
