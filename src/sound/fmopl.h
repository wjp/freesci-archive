...
#ifndef OSD_CPU_H
#define OSD_CPU_H
typedef guint8	UINT8;   /* unsigned  8bit */
typedef guint16	UINT16;  /* unsigned 16bit */
typedef guint32	UINT32;  /* unsigned 32bit */
typedef gint8	INT8;    /* signed  8bit   */
typedef gint16	INT16;   /* signed 16bit   */
typedef gint32	INT32;   /* signed 32bit   */
#endif
