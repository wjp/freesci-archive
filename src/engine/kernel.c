...
/*05*/	{KF_NEW, "DisposeClone", {kDisposeClone, "o"}},
/*06*/	{KF_NEW, "IsObject", {kIsObject, "."}},
/*07*/	{KF_NEW, "RespondsTo", {kRespondsTo, ".i"}},
/*08*/	{KF_NEW, "DrawPic", {kDrawPic, "i*"}},
/*09*/	{KF_NEW, "Show", {kShow, "i"}},
/*0a*/	{KF_NEW, "PicNotValid", {kPicNotValid, "i*"}},
/*0b*/	{KF_NEW, "Animate", {kAnimate, "LI*"}}, /* More like (li?)? */
/*0c*/	{KF_NEW, "SetNowSeen", {kSetNowSeen, "oi*"}}, /* The second parameter is ignored */
/*0d*/	{KF_NEW, "NumLoops", {kNumLoops, "o"}},
/*0e*/	{KF_NEW, "NumCels", {kNumCels, "o"}},
/*0f*/	{KF_NEW, "CelWide", {kCelWide, "iii"}},
...
/*15*/	{KF_NEW, "SetPort", {kSetPort, "i"}},
/*16*/	{KF_NEW, "DisposeWindow", {kDisposeWindow, "i"}},
/*17*/	{KF_NEW, "DrawControl", {kDrawControl, "o"}},
/*18*/	{KF_NEW, "HiliteControl", {kHiliteControl, "o"}},
/*19*/	{KF_NEW, "EditControl", {kEditControl, "ZoZo"}},
/*1a*/	{KF_NEW, "TextSize", {kTextSize, "rZrii*r*"}},
/*1b*/	{KF_NEW, "Display", {kDisplay, ".i.*"}},
/*1c*/	{KF_NEW, "GetEvent", {kGetEvent, "io"}},
/*1d*/	{KF_NEW, "GlobalToLocal", {kGlobalToLocal, "o"}},
/*1e*/	{KF_NEW, "LocalToGlobal", {kLocalToGlobal, "o"}},
/*1f*/	{KF_NEW, "MapKeyToDir", {kMapKeyToDir, "o"}},
/*20*/	{KF_NEW, "DrawMenuBar", {kDrawMenuBar, "i"}},
/*21*/	{KF_NEW, "MenuSelect", {kMenuSelect, "oi*"}},
/*22*/	{KF_NEW, "AddMenu", {kAddMenu, "rr"}},
/*23*/	{KF_NEW, "DrawStatus", {kDrawStatus, "Zri*"}},
/*24*/	{KF_NEW, "Parse", {kParse, "ro"}},
/*25*/	{KF_NEW, "Said", {kSaid, "Zr"}},
...
/*2c*/	{KF_NEW, "FClose", {kFClose, "i"}},
/*2d*/	{KF_NEW, "SaveGame", {kSaveGame, "rir"}},
/*2e*/	{KF_NEW, "RestoreGame", {kRestoreGame, "ri"}},
/*2f*/	{KF_NEW, "RestartGame", {kRestartGame, ""}},
/*30*/	{KF_NEW, "GameIsRestarting", {kGameIsRestarting, "i*"}},
/*31*/	{KF_NEW, "DoSound", {kDoSound, "iIo*"}},
/*32*/	{KF_NEW, "NewList", {kNewList, ""}},
/*33*/	{KF_NEW, "DisposeList", {kDisposeList, "l"}},
/*34*/	{KF_NEW, "NewNode", {kNewNode, ".."}},
/*35*/	{KF_NEW, "FirstNode", {kFirstNode, "Zl"}},
/*36*/	{KF_NEW, "LastNode", {kLastNode, "l"}},
/*37*/	{KF_NEW, "EmptyList", {kEmptyList, "l"}},
/*38*/	{KF_NEW, "NextNode", {kNextNode, "n"}},
/*39*/	{KF_NEW, "PrevNode", {kPrevNode, "n"}},
/*3a*/	{KF_NEW, "NodeValue", {kNodeValue, "n"}},
/*3b*/	{KF_NEW, "AddAfter", {kAddAfter, "lnn"}},
/*3c*/	{KF_NEW, "AddToFront", {kAddToFront, "ln"}},
/*3d*/	{KF_NEW, "AddToEnd", {kAddToEnd, "ln"}},
/*3e*/	{KF_NEW, "FindKey", {kFindKey, "l."}},
/*3f*/	{KF_NEW, "DeleteKey", {kDeleteKey, "l."}},
/*40*/	{KF_NEW, "Random", {kRandom, "i*"}},
/*41*/	{KF_NEW, "Abs", {kAbs, "Oi"}},
/*42*/	{KF_NEW, "Sqrt", {kSqrt, "i"}},
/*43*/	{KF_NEW, "GetAngle", {kGetAngle, "iiii"}},
/*44*/	{KF_NEW, "GetDistance", {kGetDistance, "iiiii*"}},
/*45*/	{KF_NEW, "Wait", {kWait, "i"}},
/*46*/	{KF_NEW, "GetTime", {kGetTime, "i*"}},
/*47*/	{KF_NEW, "StrEnd", {kStrEnd, "r"}},
/*48*/	{KF_NEW, "StrCat", {kStrCat, "rr"}},
/*49*/	{KF_NEW, "StrCmp", {kStrCmp, "rri*"}},
/*4a*/	{KF_NEW, "StrLen", {kStrLen, "r"}},
/*4b*/	{KF_NEW, "StrCpy", {kStrCpy, "rri*"}},
/*4c*/	{KF_NEW, "Format", {kFormat, "r.*"}},
/*4d*/	{KF_NEW, "GetFarText", {kGetFarText, "iir"}},
/*4e*/	{KF_NEW, "ReadNumber", {kReadNumber, "r"}},
...
/*5a*/	{KF_NONE, "ShowObjs"},
/*5b*/	{KF_NONE, "ShowFree"},
/*5c*/	{KF_NEW, "MemoryInfo", {kMemoryInfo, "i"}},
/*5d*/	{KF_NONE, "StackUsage"},
/*5e*/	{KF_NONE, "Profiler"},
/*5f*/	{KF_NEW, "GetMenu", {kGetMenu, "i."}},
/*60*/	{KF_NEW, "SetMenu", {kSetMenu, "i.*"}},
/*61*/	{KF_NEW, "GetSaveFiles", {kGetSaveFiles, "rrr"}},
/*62*/	{KF_NEW, "GetCWD", {kGetCWD, "r"}},
/*63*/	{KF_NEW, "CheckFreeSpace", {kCheckFreeSpace, "r"}},
/*64*/	{KF_NEW, "ValidPath", {kValidPath, "r"}},
/*65*/	{KF_NEW, "CoordPri", {kCoordPri, "i"}},
/*66*/	{KF_NEW, "StrAt", {kStrAt, "rii*"}},
#ifdef _WIN32
/*67*/	{KF_NEW, "DeviceInfo", {kDeviceInfo_Win32, "i.*"}},
#else /* !_WIN32 */
/*67*/	{KF_NEW, "DeviceInfo", {kDeviceInfo_Unix, "i.*"}},
#endif
/*68*/	{KF_NEW , "GetSaveDir", {kGetSaveDir, ""}},
/*69*/	{KF_NEW, "CheckSaveGame", {kCheckSaveGame, ".*"}},
/*6a*/	{KF_NEW, "ShakeScreen", {kShakeScreen, "ii*"}},
...
/*74*/	{KF_NEW, "FileIO", {kFileIO, "i.*"}},
/*(?)*/	{KF_NEW, "Memory", {kMemory, "i.*"}},
...
/*(?)*/	{KF_NEW, "Lock", {kLock, "iii"}},
  ...
  /* Non-experimental Functions without a fixed ID */
	...
	{KF_NEW, "CosMult", {kTimesCos, "ii"}},
	{KF_NEW, "SinMult", {kTimesSin, "ii"}},
/*(?)*/	{KF_NEW, "CosDiv", {kCosDiv, "ii"}},
/*(?)*/	{KF_NEW, "PriCoord", {kPriCoord, "i"}},
/*(?)*/	{KF_NEW, "SinDiv", {kSinDiv, "ii"}},
/*(?)*/	{KF_NEW, "TimesCot", {kTimesCot, "ii"}},
/*(?)*/	{KF_NEW, "TimesTan", {kTimesTan, "ii"}},
