...
/* Auto-generation performed by cfsml.pl 0.8.0 */
#line 486 "CFSML input file"
struct {
...
full_widget_tree_traversal(gfxw_widget_t *widget, gfxw_container_t *parent, gfxw_visual_t *visual)
{
	...
	fprintf(stderr,"Setting vis to %p in wSerial %x\n", visual, widget->serial);
...
/* End of auto-generated CFSML data reader code */
#line 1011 "CFSML input file"

	fclose(fh);

	if ((retval->savegame_version < FREESCI_SAVEGAME_VERSION) || (retval->savegame_version > FREESCI_SAVEGAME_VERSION)) {
